...
This document establishes the authoritative sources of truth for all domains within the `kice-math-agent-infra` system (v2.8.2). Any conflict between documents must be resolved by referring to the designated SSoT for that domain.
